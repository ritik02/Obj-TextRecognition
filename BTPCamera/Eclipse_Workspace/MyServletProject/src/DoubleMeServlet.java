       ...
       /*  
        ...
        //   url[pic+2]=new URL("http://i350.photobucket.com/albums/q410/ritikxman/nfd_zps3ou92bsp.png");
           ...
           */
                    ...
                    for(int i=0;i<pic;i++)
     {
    	 image[i] = ImageIO.read(this.getClass().getResource("/n"+(i+1)+".jpg"));
    	 image[i]=resize(image[i],nopp,nopp);
    	 image[i]=greyscales(image[i]);
     }
                   
   imagetest = ImageIO.read(this.getClass().getResource("/n54.jpg"));
	 imagetest=resize(imagetest,100,100);
...
"arpit","arpit","arpit","arpit","ritik","ritik","ritik","ritik"};*/
        	      ...
        	      //  String ss[] = {
        	       // 	"KV Arya Sir","KV Arya Sir","KV Arya Sir","KV Arya Sir","KV Arya Sir","KV Arya Sir","KV Arya Sir","KV Arya Sir","Ritik","Ritik","Ritik","Ritik","Ritik","Ritik","Ritik","Ritik",};
        	        ...
        	        String ss[] = {"Sub03","Sub03","Sub03","Sub03","Sub03","Sub03","Sub03","Sub03","Sub03","Sub03","Sub09","Sub09","Sub09","Sub09","Sub09","Sub09","Sub09","Sub09","Sub09","Sub09","Sub05","Sub05","Sub05","Sub05","Sub05","Sub05","Sub05","Sub05","Sub05","Sub05","Sub08","Sub08","Sub08","Sub08","Sub08","Sub08","Sub08","Sub08","Sub08","Sub08","Sub07","Sub07","Sub07","Sub07","Sub07","Sub07","Sub07","Sub07","Sub07","Sub07","Sub06","Sub06","Sub06","Sub06","Sub06","Sub06","Sub06","Sub06","Sub06","Sub06",};
        	      //  Log.i("evectors", "" + ee);
        	       // Log.i("evectors", "" + min);
        	       // Log.i("evectors", "" + ans);
        	        //  max=4000;
